...
class CarCrossingTrackerStable:
    ...
    def __init__(
        ...
        self.csv_writer.writerow(["car_id", "lane_id", "timestamp_s", "x_cross_px", "vx_px_s", "speed_mph", "snapshot_path"])
        ...
        # UI
        self.window_name = "Car Tracking (Stable Defaults + KF mph + lanes.json)"
            ...
            for tid in seen_this_frame:
                ...
                if prev is not None:
                    ...
                    if prev_front < self.x_cross <= front:
                        ...
                        print(f"[EVENT] car_id={tid} lane={lane_id} t={t_cross:.3f}s vx={vx:.2f}px/s mph={speed_mph:.1f}")
