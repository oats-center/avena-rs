...
: "${CLIP_PRE_SEC:=5}"
: "${CLIP_POST_SEC:=5}"
: "${CLIP_PROCESS_LAG_SEC:=10}"
: "${CLIP_PROCESS_INTERVAL_SEC:=2}"
...
export TRIGGER_SUBJECT_FILTER TRIGGER_CONSUMER_DURABLE TRIGGER_STATE_BUCKET CLIP_PRE_SEC CLIP_POST_SEC CLIP_PROCESS_LAG_SEC CLIP_PROCESS_INTERVAL_SEC CLIP_COMPACTION_INTERVAL_SEC CLIP_WORKER_POLL_INTERVAL_SEC CLIP_OUTPUT_PREFIX CLIP_CAMERA_IDS RAW_RETENTION_SEC
